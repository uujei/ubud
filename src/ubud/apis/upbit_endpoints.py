...
class DepositsGenerateCoinAddress(BaseModel):
    method: str = "post"
    prefix: str = "/deposits/generate_coin_address"
    currency: str
...
class DepositsCoinAddress(BaseModel):
    method: str = "get"
    prefix: str = "/deposits/coin_address"
    currency: str = None
...
class DepositsCoinAddresses(BaseModel):
    method: str = "get"
    prefix: str = "/deposits/coin_addresses"
    currency: str = None
    deposit_address: str = None
    secondary_address: str = None
